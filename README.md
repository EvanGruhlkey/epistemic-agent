...
<details open>
<summary><strong>Pixel duck</strong> (click to hide or show)</summary>

<p align="center">
  <img src="assets/duck-pixel.svg" alt="Pixel art rubber duck" width="112" height="112" />
</p>
...
├── LICENSE
├── assets/duck-pixel.svg               # Pixel duck (also used in README toggle)
